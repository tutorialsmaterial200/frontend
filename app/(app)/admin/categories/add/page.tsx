      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <aside className="w-20 bg-gradient-to-b from-purple-50 to-white shadow-sm fixed left-0 top-16 bottom-0 z-50 border-r border-gray-200 flex flex-col items-center py-6 gap-4">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <button
              onClick={() =>
                setActiveSection(
                  activeSection === "subcategories" ? null : "subcategories"
                )
              }
              className={`w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 ${
            ...
            <button
              onClick={() =>
                setActiveSection(
                  activeSection === "ecommerce" ? null : "ecommerce"
                )
              }
              className={`w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 ${
            ...
            <button
              onClick={() =>
                setActiveSection(
                  activeSection === "analytics" ? null : "analytics"
                )
              }
              className={`w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 ${
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-purple-200 relative">
              <Image
                src="https://pub-159b5a6286b349fdb22b19baaf022bad.r2.dev/Home/Slider/placeholder.webp"
                alt="User"
                fill
          ...
          <div className="p-4">
            ...
            <nav className="space-y-1">
              ...
              <div className="pt-4">
                ...
                <button
                  onClick={() =>
                    setActiveSection(activeSection === "staff" ? null : "staff")
                  }
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 ${
                    activeSection === "staff"
                      ? "bg-gray-100 text-gray-900"
                ...
                {isSidebarOpen && activeSection === "ecommerce" && (
                  <div className="ml-8 mt-1 space-y-0.5">
                    <button className="w-full flex items-center justify-between gap-2 px-3 py-2 rounded-md text-xs text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200">
                      ...
                      <Badge
                        variant="outline"
                        className="text-xs border-gray-300 text-gray-600 h-5 px-1.5"
                      >
                        0
                      </Badge>
                    </button>
              ...
              <div className="pt-4">
                ...
                <button
                  onClick={() =>
                    setActiveSection(activeSection === "ride" ? null : "ride")
                  }
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 ${
                    activeSection === "ride"
                      ? "bg-gray-100 text-gray-900"
        ...
        <div
          className={`flex-1 transition-all duration-300 ${
            isIconSidebarOpen ? "ml-[336px]" : "ml-20"
          }`}
        >
              ...
              <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Label
                      htmlFor="name"
                      className="text-base font-bold text-gray-900 mb-3 block"
                    >
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <Button
                        type="button"
                        variant={
                          formData.status === "inactive" ? "default" : "outline"
                        }
                        onClick={() =>
